...
__author__ = "TBHUserBot <https://github.com/The-BrotherHood-Council/tbh-ubserbot>"
__copyright__ = f"TBHUserBot Copyright (C) 2020 - 2021  {__author__}"

catub.version = __version__
catub.tgbot.version = __version__
LOGS = logging.getLogger("TBHUserbot")
bot = catub
